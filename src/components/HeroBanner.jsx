...
export default function HeroBanner() {
    ...
    const numberStyle = "bg-setOrange px-4 py-1.5 rounded-[50%] ml-2 mr-4 text-white"
    ...
    <div className="flex w-[100%] justify-center flex-wrap">
        <div className="mx-2 px-4 my-2 w-[90vw] bg-amber-50 text-neutral-500 rounded-xl">
            ...
            <p className="text-[1.25rem] my-6"><span className={numberStyle}>1</span>Send us photos for a quote</p>
            <p className="text-[1.25rem] my-6"><span className={numberStyle}>2</span> Find a time that suits you</p>
            <p className="text-[1.25rem]"><span className={numberStyle}>3</span> We come to you!</p>
        ...
        <div className="mx-2 px-4 my-2 w-[90vw] bg-blue-700 rounded-xl">
            ...
            <div className="flex place-items-center  mt-3">
                ...
                <p className="text-[1.25rem]">40+ years experience in panel beating</p>
            </div>
